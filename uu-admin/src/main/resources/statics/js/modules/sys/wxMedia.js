...
$(".js_btn").click(function () {
    ...
    if(index == 1){
        ...
        parent.$("#news").find('.jsMsgSendTab').css('display','none');
        parent.$(".send").css('display','block');
        parent.$(".msg_sender_area").css('display','none');

        parent.$("#news").append(mediaHtml);
        ...
        console.log(parent.vm.wxKey != undefined)

        if(parent.vm.wxKey != undefined){
            parent.vm.wxKey.msgType = "news";
            parent.vm.wxKey.mediaid = mid;
            console.log(parent.vm.wxKey.mediaid)
        }
